...
! function (a) {
    ...
    a.magnificPopup.registerModule(I, {
        options: {
            settings: null,
            cursor: "mfp-ajax-cur",
            tError: '<a href="%url%">این محتوا</a> نمی تواند بارگزاری شود.'
        },
        proto: {
            initAjax: function () {
    ...
    a.magnificPopup.registerModule("image", {
        options: {
            ...
            titleSrc: "title",
            verticalFit: !0,
            tError: '<a href="%url%">این تصویر</a> نمی تواند بارگزاری شود.'
        },
        proto: {
            initImage: function () {
                var c = b.st.image,
            ...
            initGallery: function () {
                ...
                return b.direction = !0, c && c.enabled ? (f += " mfp-gallery", w(m + e, function () {
                    ...
                    if (b.items.length > 1 && c.arrows && !b.arrowLeft) {
                        var d = c.arrowMarkup,
                            e = b.arrowLeft = a(d.replace(/%title%/gi, c.tPrev).replace(/%dir%/gi, "right")).addClass(s),
                            f = b.arrowRight = a(d.replace(/%title%/gi, c.tNext).replace(/%dir%/gi, "left")).addClass(s);
                        e.click(function () {
                            b.prev()
                        }), f.click(function () {
                            b.next()
